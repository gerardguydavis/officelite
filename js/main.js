...
function setInitial() {
    let seconds = Math.floor((initialDistance / 1000) % 60);
    let minutes = Math.floor((initialDistance / 1000 / 60) % 60);
    let hours = Math.floor((initialDistance / (1000 * 60 * 60)) % 24);
    let days = Math.floor(initialDistance / (1000 * 60 * 60 * 24));
    if (days < 10) {
